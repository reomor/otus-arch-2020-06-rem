...
import ru.otus.softwaredesign.auth.domain.AppResponse;
import ru.otus.softwaredesign.auth.domain.HealthResponse;
import ru.otus.softwaredesign.auth.domain.VersionResponse;
